...
from app.services.rag_chatbot import chroma_client, SentenceTransformerEmbeddingFunction, get_llm_provider
from app.core.config import settings

def main():
    report_file = "/mnt/c/Users/sadik/Documents/Hexplain/tests/reports_and_logs/verification_pe_full_report_final.json"
    ...
    with open("evidence_step1.json", "w") as out:
    ...
    with open("evidence_step2.json", "w") as out:
        json.dump(llm_report.get("llm_risk_assessment", {}), out, indent=2)
    with open("evidence_llm_full.json", "w") as out:
...
"""
    ...
    with open("evidence_step3.json", "w") as f:
