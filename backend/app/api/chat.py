...
def chat_with_report(
    ...
    Returns an answer grounded strictly in the report's evidence.
    """
    ...
    try:
        ...
        # Strip heavy code elements to save token context
    ...
    user_msg = ChatMessage(job_id=job_id, role="user", content=user_msg_content)
    db.add(user_msg)
    db.commit()
