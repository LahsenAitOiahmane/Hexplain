...
import { Loader2, ArrowLeft, Terminal, Code, AlertTriangle, MessageSquare, X, Wand2 } from "lucide-react";
  ...
  const explainCode = async () => {
    ...
    try {
      const res = await api.post(`/jobs/${id}/chat`, {
        question: "Please explain this selected code snippet in detail. What is its purpose and how does it work?",
        code_context: selectedCode
      });
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 relative">
      ...
      <div className={cn(
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-50">
          <div className="mb-6">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Selected Code Snippet</div>
