...
import { Shield, ArrowRight, Activity, Binary, Lock, Mail, User } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 md:px-24 lg:px-32 relative z-10 bg-white/80 backdrop-blur-xl">
        <div className="w-full max-w-sm mx-auto">
          <div className="mb-10 text-center sm:text-left">
            ...
            <p className="text-gray-500 mt-2 text-sm">Join to start analyzing binaries securely.</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            Already have an account? <Link href="/login" className="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">Sign in here</Link>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-slate-50 items-center justify-center p-12">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-sky-50 via-white to-indigo-50 z-0"></div>
        <div className="absolute top-24 left-24 w-96 h-96 bg-indigo-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-24 right-24 w-72 h-72 bg-sky-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="relative z-10 w-full max-w-lg">
          <div className="glass-panel p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Secure by design</h2>
            </div>
            <p className="text-gray-600 leading-relaxed mb-8">
              Join thousands of analysts securing their infrastructure. Uploaded binaries are analyzed in isolated environments and never executed.
            </p>
            <div className="space-y-4">
              {[
                { icon: Lock, title: "Data Privacy", desc: "Your reports are private and retained for 7 days" },
                { icon: Binary, title: "Multi-Architecture", desc: "Support for Windows PE, Linux ELF, and .NET" }
              ].map((item, i) => (
